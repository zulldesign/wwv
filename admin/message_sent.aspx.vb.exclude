...
Partial Class executive_message_sent
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Title = "İİYG PORTAL | Mesajlar | Gönderilmiş Mesajlar"
        SessionBul()
    ...
    Sub MesajlariYaz()
        ...
        comm = New OleDbCommand("SELECT mesajlar.id,[users].name,[users].surname,mesajlar.alici,mesajlar.mesaj,mesajlar.tarih,[users].name,[users].[name] as ad2 from mesajlar,[users] where mesajlar.gonderen='" & UserName & "' and [users.sicil]=mesajlar.gonderen order by tarih DESC", conn)
        conn.Open()
    ...
    Sub TabloBaslangic()
        ...
        TabloString = TabloString & "<td style='border-style: dotted; border-width: 1px;border-color:#999999;'>"
        TabloString = TabloString & "<b>Alıcı:</b></td>"
