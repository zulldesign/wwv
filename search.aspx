<%@ Page Language="VB" MasterPageFile="masterpage.master" AutoEventWireup="false" CodeFile="search.aspx.vb" Inherits="search" title="Untitled Page" Debug="true"   %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<asp:Label ID="PagingTxt" runat="server"></asp:Label>
    <br />



    	
	<asp:Label ID="GoogleSearchTxt" runat="server"></asp:Label>
